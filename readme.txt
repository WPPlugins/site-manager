=== Site Manager ===
Contributors: 1and1, markoheijnen
...
1. Upload the `Site Manager` to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. In your WordPress Dashboard select: Site Manager > Settings.
...
Site Manager checks for updates **every 12 hours**. Updates are then installed automatically.
...
When your installation doesn’t allow major updates the settings will not be visible within the Site Manager Settings.
